...
void champion(victory VictoryCheck);
...
void champion(victory VictoryCheck)
{
	if (VictoryCheck.FirstPlayerWins > VictoryCheck.SecondPlayerWins)
	{
		cout << "*** Player Number 1 ( O ) is THE CHAMPION ***" << endl;
	}
	else if (VictoryCheck.FirstPlayerWins < VictoryCheck.SecondPlayerWins)
	{
		cout << "*** Player Number 2 ( X ) is THE CHAMPION ***" << endl;
	}
	else
	{
		cout << " *** YOUR MATCH IS TIE *** " << endl;
	}
}
